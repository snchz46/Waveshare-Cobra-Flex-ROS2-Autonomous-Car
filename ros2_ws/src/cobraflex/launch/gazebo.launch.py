...
def generate_launch_description():
    ...
    urdf_path = os.path.join(get_package_share_directory(package_name),'urdf','my_robot_basic.urdf')
    ...
    ekf_node = Node(
        ...
        output='screen',
        parameters=[
            os.path.join(get_package_share_directory(package_name), 'config', 'ekf_gazebo.yaml'),
